...
namespace API_PCC.Controllers
{
    ...
    public class AuditTrailController : ControllerBase
    {
        ...
        public AuditTrailController(ODC_HRISContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        public async Task<ActionResult<IEnumerable<AuditTrailModel>>> list(CommonSearchFilterModel searchFilter)
        {
            try
            {
