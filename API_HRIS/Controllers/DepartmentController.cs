...
namespace API_HRIS.Controllers
{
    ...
    public class DepartmentController : ControllerBase
    {
        ...
        public async Task<ActionResult<TblDeparmentModel>> save(TblDeparmentModel tblDeparmentModel)
        {
            ...
            bool hasDuplicateOnSave = (_context.TblDeparmentModels?.Any(departmentModel => departmentModel.DepartmentName == tblDeparmentModel.DepartmentName)).GetValueOrDefault();
            ...
            try
            {
                ...
                string status = "Department successfully saved";
        ...
        public async Task<IActionResult> delete(DeletionModel deletionModel)
        {
            ...
            if (departmentModel == null || departmentModel.Status == 0)
            {
                return Conflict("No records matched!");
            }
        ...
        public async Task<IActionResult> restore(RestorationModel restorationModel)
        {
            ...
            if (departmentModel == null || departmentModel.Status == 1)
            {
        ...
        public async Task<ActionResult<IEnumerable<TblDeparmentModel>>> view()
        {
            ...
            return await _context.TblDeparmentModels.Where(deparmentModel => deparmentModel.Status == 1).ToListAsync();
            string status = "Department successfully viewed";
