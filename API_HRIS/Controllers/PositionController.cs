...
namespace API_HRIS.Controllers
{
    ...
    public class PositionController : ControllerBase
    {
        ...
        {
            return Ok(_context.TblPositionModels.Where(a => a.Status == 1).OrderByDescending(a=>a.Id).ToList());
        }
        ...
        public async Task<IActionResult> delete(DeletionModel deletionModel)
        {
            ...
            if (positionModel == null || positionModel.Status == 0)
            {
                return Conflict("No records matched!");
            }
        ...
        public async Task<IActionResult> restore(RestorationModel restorationModel)
        {
            ...
            if (positionModel == null || positionModel.Status == 1)
            {
        ...
        public async Task<ActionResult<IEnumerable<TblPositionModel>>> view()
        {
            ...
            return await _context.TblPositionModels.Where(positionModel => positionModel.Status == 1).ToListAsync();
